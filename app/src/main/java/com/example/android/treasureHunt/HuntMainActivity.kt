...
class HuntMainActivity : AppCompatActivity() {
    ...
    private val runningQOorLater = android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q
 ...
 */
    ...
    private fun foregroundAndBackgroundLocationPermissionApproved(): Boolean {
        ...
        val backgroudPermissionApproved =
            if (runningQOorLater) {
        ...
        return foregroundLocationApproved && backgroudPermissionApproved
    }
    ...
    private fun removeGeofences() {
        ...
        //ELE REMOVE O GEOFENCE PELO PENDING INTENT QUE ESTAVA SENDO UTILIZADO PRA MONITORAR
        if (!foregroundAndBackgroundLocationPermissionApproved()){
            return
        }
